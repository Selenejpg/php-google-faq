...
$faqs = [
    ...
    [
        'question' => '<h3 style="text-align: left; margin-left: 15%; margin-right: 15%">Come state implementando la recente decisione della Corte di giustizia dell\'Unione europea (CGUE) relativa al diritto all\'oblio?</h3>',
